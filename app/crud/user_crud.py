class UserCRUD:
    # Create a new user
    @staticmethod
    def create_user(db_conn,*,id:str,email: str, phone: str, hashed_password: str):
        sql = """
        INSERT INTO users (id,email, phone, hashed_password)
        VALUES (%s,%s, %s, %s)
        """
        db_conn.cursor.execute(sql, (id,email, phone, hashed_password))
